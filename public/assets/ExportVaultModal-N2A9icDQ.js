import{D as e,K as t,S as n,Z as r,_ as i,b as a,gt as o,ht as s,mt as c,nt as l}from"./index-gXJSogL1.js";var u=c(`file-code`,[[`path`,{d:`M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z`,key:`1oefj6`}],[`path`,{d:`M14 2v5a1 1 0 0 0 1 1h5`,key:`wfsgrz`}],[`path`,{d:`M10 12.5 8 15l2 2.5`,key:`1tg20x`}],[`path`,{d:`m14 12.5 2 2.5-2 2.5`,key:`yinavb`}]]),d=c(`file-spreadsheet`,[[`path`,{d:`M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z`,key:`1oefj6`}],[`path`,{d:`M14 2v5a1 1 0 0 0 1 1h5`,key:`wfsgrz`}],[`path`,{d:`M8 13h2`,key:`yr2amv`}],[`path`,{d:`M14 13h2`,key:`un5t4a`}],[`path`,{d:`M8 17h2`,key:`2yhykz`}],[`path`,{d:`M14 17h2`,key:`10kma7`}]]),f=c(`loader-circle`,[[`path`,{d:`M21 12a9 9 0 1 1-6.219-8.56`,key:`13zald`}]]),p=o(s()),m=a(),h=({assets:e,userName:n=`Valued User`})=>{let[r,i]=(0,p.useState)(!1);return(0,m.jsxs)(`button`,{onClick:()=>{i(!0);let t=window.open(``,`_blank`);if(!t){console.warn(`Pop-up blocked by browser settings`),i(!1);return}let r=e.reduce((e,t)=>e+(Number(t.price)||0),0),a=e.length>0?Math.round(r/e.length):0,o=`
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body>
          <div class="header">
            ...
            <div style="text-align: right;">
              <p style="font-size: 12px; font-weight: bold; margin: 0;">यूज़र: ${n}</p>
    ...
    `;t.document.write(o),t.document.close(),i(!1)},disabled:r||e.length===0,className:`flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-4 py-2.5 rounded-xl font-semibold text-xs transition shadow-md disabled:opacity-50 cursor-pointer`,children:[r?(0,m.jsx)(f,{className:`w-4 h-4 animate-spin`}):(0,m.jsx)(t,{className:`w-4 h-4`}),(0,m.jsx)(`span`,{children:`PDF रिपोर्ट डाउनलोड करें`})]})},g=({isOpen:a,onClose:o,assets:s,totalValuation:c})=>{if(!a)return null;let f=new Date().toISOString().split(`T`)[0];return(0,m.jsx)(`div`,{className:`fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fade-in`,children:(0,m.jsxs)(`div`,{className:`relative w-full max-w-lg rounded-3xl bg-slate-900 border border-slate-800 shadow-2xl p-6 overflow-hidden`,children:[(0,m.jsxs)(`div`,{className:`flex items-center justify-between pb-4 border-b border-slate-800`,children:[(0,m.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,m.jsx)(`div`,{className:`p-3 rounded-2xl bg-teal-500/10 border border-teal-500/20 text-teal-400`,children:(0,m.jsx)(r,{className:`w-5 h-5 animate-bounce`})}),(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`h2`,{className:`text-lg font-bold text-white tracking-tight`,children:`Export Vault Summary Report`}),(0,m.jsx)(`p`,{className:`text-xs text-slate-400`,children:`Download verified inventory logs, warranty certificates, or backup files`})]})]}),(0,m.jsx)(`button`,{onClick:o,className:`p-2 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 transition-colors cursor-pointer`,children:(0,m.jsx)(n,{className:`w-5 h-5`})})]}),(0,m.jsxs)(`div`,{className:`py-6 space-y-3`,children:[(0,m.jsxs)(`button`,{onClick:()=>{let e=[`ID`,`Asset Name`,`Brand`,`Category`,`Price (INR)`,`Purchase Date`,`Warranty Expiry Date`,`Days Remaining`,`Warranty Status`,`Vendor / Store`,`Serial Number`,`Notes`],t=s.map(e=>[e.id,`"${(e.name||``).replace(/"/g,`""`)}"`,`"${(e.brand||``).replace(/"/g,`""`)}"`,`"${(e.category||``).replace(/"/g,`""`)}"`,e.price||0,e.purchaseDate||``,e.expiryDate||``,e.daysRemaining??0,e.status||`active`,`"${(e.vendor||``).replace(/"/g,`""`)}"`,`"${(e.serialNumber||``).replace(/"/g,`""`)}"`,`"${(e.notes||``).replace(/"/g,`""`)}"`]),n=[e.join(`,`),...t.map(e=>e.join(`,`))].join(`
`),r=new Blob([n],{type:`text/csv;charset=utf-8;`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.setAttribute(`download`,`AssetDoctor_Vault_Summary_${f}.csv`),document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i),o()},className:`w-full p-4 rounded-2xl bg-slate-950 border border-slate-800 hover:border-emerald-500/50 hover:bg-emerald-950/10 text-left transition-all group flex items-center justify-between cursor-pointer`,children:[(0,m.jsxs)(`div`,{className:`flex items-center gap-3.5`,children:[(0,m.jsx)(`div`,{className:`p-3 rounded-xl bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 group-hover:scale-110 transition-transform`,children:(0,m.jsx)(d,{className:`w-5 h-5`})}),(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`div`,{className:`text-sm font-bold text-white group-hover:text-emerald-300 transition-colors`,children:`CSV Spreadsheet (.csv)`}),(0,m.jsx)(`div`,{className:`text-xs text-slate-400 mt-0.5`,children:`Structured table format for Excel, Google Sheets, or tax filing`})]})]}),(0,m.jsx)(e,{className:`w-4 h-4 text-emerald-400 opacity-0 group-hover:opacity-100 transition-opacity`})]}),(0,m.jsxs)(`button`,{onClick:()=>{let e=`<!DOCTYPE html>
<html>
<head>
  ...
  <div class="container">
    ...
    <div class="summary-grid">
      <div class="stat-card">
        ...
        <div class="stat-val">${s.length} Items</div>
      </div>
      <div class="stat-card">
        <div class="stat-label">Total Vault Valuation</div>
        <div class="stat-val" style="color: #34d399">${i(c)}</div>
      </div>
      <div class="stat-card">
        <div class="stat-label">Expiring Soon (&le; 30d)</div>
        <div class="stat-val" style="color: #fbbf24">${s.filter(e=>e.status===`expiring_soon`).length} Items</div>
      </div>
    </div>
      ...
      <tbody>
        ${s.map(e=>`
          <tr>
            ...
            <td style="font-family: monospace; font-weight:700">${i(e.price)}</td>
            <td>${e.expiryDate}</td>
...
</html>`,t=new Blob([e],{type:`text/html`}),n=URL.createObjectURL(t);if(!window.open(n,`_blank`)){let e=document.createElement(`a`);e.href=n,e.setAttribute(`download`,`AssetDoctor_Vault_Report_${f}.html`),document.body.appendChild(e),e.click(),document.body.removeChild(e)}URL.revokeObjectURL(n),o()},className:`w-full p-4 rounded-2xl bg-slate-950 border border-slate-800 hover:border-cyan-500/50 hover:bg-cyan-950/10 text-left transition-all group flex items-center justify-between cursor-pointer`,children:[(0,m.jsxs)(`div`,{className:`flex items-center gap-3.5`,children:[(0,m.jsx)(`div`,{className:`p-3 rounded-xl bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 group-hover:scale-110 transition-transform`,children:(0,m.jsx)(t,{className:`w-5 h-5`})}),(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`div`,{className:`text-sm font-bold text-white group-hover:text-cyan-300 transition-colors`,children:`Printable Summary Certificate (PDF)`}),(0,m.jsx)(`div`,{className:`text-xs text-slate-400 mt-0.5`,children:`Formatted visual certificate report with total valuation & active status`})]})]}),(0,m.jsx)(e,{className:`w-4 h-4 text-cyan-400 opacity-0 group-hover:opacity-100 transition-opacity`})]}),(0,m.jsxs)(`button`,{onClick:()=>{let e=JSON.stringify(s,null,2),t=new Blob([e],{type:`application/json`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=`AssetDoctor_ServiVault_Backup_${f}.json`,r.click(),URL.revokeObjectURL(n),o()},className:`w-full p-4 rounded-2xl bg-slate-950 border border-slate-800 hover:border-teal-500/50 hover:bg-teal-950/10 text-left transition-all group flex items-center justify-between cursor-pointer`,children:[(0,m.jsxs)(`div`,{className:`flex items-center gap-3.5`,children:[(0,m.jsx)(`div`,{className:`p-3 rounded-xl bg-teal-500/10 text-teal-400 border border-teal-500/20 group-hover:scale-110 transition-transform`,children:(0,m.jsx)(u,{className:`w-5 h-5`})}),(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`div`,{className:`text-sm font-bold text-white group-hover:text-teal-300 transition-colors`,children:`Full State Backup (.json)`}),(0,m.jsx)(`div`,{className:`text-xs text-slate-400 mt-0.5`,children:`Complete raw data dump for migration or full vault restoring`})]})]}),(0,m.jsx)(l,{className:`w-4 h-4 text-teal-400 opacity-0 group-hover:opacity-100 transition-opacity`})]})]}),(0,m.jsxs)(`div`,{className:`pt-4 border-t border-slate-800 flex items-center justify-between text-xs text-slate-500`,children:[(0,m.jsxs)(`span`,{children:[`Total Vault Value: `,(0,m.jsx)(`strong`,{className:`text-emerald-400 font-mono`,children:i(c)})]}),(0,m.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,m.jsx)(h,{assets:s}),(0,m.jsx)(`button`,{onClick:o,className:`px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 font-bold transition-colors cursor-pointer`,children:`Close`})]})]})]})})};export{g as ExportVaultModal};