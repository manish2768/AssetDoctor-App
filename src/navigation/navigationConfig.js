...
/**
 * 1. Primary Navigation Destinations
 */
export const MAIN_NAV_ITEMS = [
  ...
  },
  {
    id: 'scan_identify',
    label: 'Scan & Identify',
    subtitle: 'Smart OCR for any bill, RC or policy',
    icon: 'scan',
    isHeroScanner: true,
    badge: 'Smart OCR',
    enabled: true,
  ...
  },
  {
    ...
    subtitle: 'Upcoming expiry & service alerts',
    icon: 'bell',
    route: 'Alerts',
...
export const ASSET_CATEGORIES_CONFIG = [
  {
    ...
    folder: 'vehicle',
    route: 'Assets',
    params: { screen: 'AssetList', folder: 'vehicle' },
    color: '#0D9488',
    enabled: true,
    order: 1,
  },
  {
    ...
    folder: 'appliance',
    route: 'Assets',
    params: { screen: 'AssetList', folder: 'electronics' },
    color: '#0891B2',
    enabled: true,
    order: 2,
  },
  ...
  },
  {
    ...
    folder: 'equipment',
    route: 'Assets',
    params: { screen: 'AssetList', folder: 'property' },
    color: '#D97706',
    enabled: true,
    order: 4,
  },
  ...
  },
  {
    ...
    folder: 'other',
    route: 'Assets',
    params: { screen: 'AssetList', folder: 'personal' },
    color: '#64748B',
    enabled: true,
    order: 6,
  },
...
export const ACCOUNT_NAV_ITEMS = [
  ...
  },
  {
    ...
    subtitle: 'Version 1.0.67 (122) · Enterprise Vault Edition',
    icon: 'shield-check',
    route: 'Profile',
    params: { screen: 'About' },
    enabled: true,
